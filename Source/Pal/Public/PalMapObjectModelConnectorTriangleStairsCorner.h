...
#include "PalMapObjectModelConnectorTriangleStairsCorner.generated.h"

UCLASS(Blueprintable)
class PAL_API UPalMapObjectModelConnectorTriangleStairsCorner : public UPalMapObjectModelConnectorBase {
    GENERATED_BODY()
public:
private:
...
public:
    UPalMapObjectModelConnectorTriangleStairsCorner();
