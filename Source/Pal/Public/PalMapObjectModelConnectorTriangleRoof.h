...
#include "PalMapObjectModelConnectorTriangleRoof.generated.h"

UCLASS(Blueprintable)
class PAL_API UPalMapObjectModelConnectorTriangleRoof : public UPalMapObjectModelConnectorBase {
    GENERATED_BODY()
public:
private:
...
public:
    UPalMapObjectModelConnectorTriangleRoof();
