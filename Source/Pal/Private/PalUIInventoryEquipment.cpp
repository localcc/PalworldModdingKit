...
void UPalUIInventoryEquipment::SwapEquipmentByLiftItem(EPalPlayerEquipItemSlotType slotType) {
}

void UPalUIInventoryEquipment::RequestUpdatePlayerStatusPoint(const TMap<FName, int32>& AddPointMap) {
}
